...
| 02.09.2022      | 0.0.1     |      Random Zahlen generieren, tiefer/höcher, anzahl versuche angezeigt   |        
|08.09.2022|0.02|    Console  farbig gemacht,  Neustart ohne die Console zu schliessen              |
|       | 1.0.0   |                                                              |
...
|  5  | muss  | Funktion  | Als benutzer will ich, dass der Komputer die Anzahl versuche anzeigt, nachedem die Zahl erraten wurde, damit ich meine Resultate mit anderen vergleichen könnte
|  6  | kann  | Funktion  | Als benutzer will ich ,dass der Komputer erkennt wenn ein Wort anstaat ein Zahl eingegeben wurde und mir erklärt, das es nicht geht, damit ich nicht verwirrt werde
...
|9|kann|Funktion|Als Benutzer will ich, dass das Spiel schwieriger wird, nachdem ich 5 mal gewonnen habe, damit es spannend bleibt aka Winstreak|
|10|kann|Funktion|als SPieler will ich Musik in den Spiel haben, damit es mehr engaging wird| 
|11|kann|Funktion|Als Spieler will ich ..|
...
|8.A|?|Kamil|Console sollte farbig sein||
Total: 
